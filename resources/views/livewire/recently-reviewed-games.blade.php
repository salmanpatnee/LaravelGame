    ...
    @forelse ($recentlyReviewedGames as $game)
        <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
            <div class="relative flex-none">
                ...
                <div id="" class="absolute bottom-0 right-0 w-16 h-16 bg-gray-900 rounded-full text-xs" style="right: -20px; bottom: -20px">
    ...
    @empty
        @foreach (range(1, 3) as $game)
            <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                ...
                <div class="ml-6 lg:ml-12">
                    <div class="inline-block text-lg font-semibold leading-tight text-transparent bg-gray-700 rounded mt-4 w-44 h-5"></div>
                    <div class="mt-8 space-y-4 hidden lg:block">
                        <span class="text-transparent bg-gray-700 rounded block w-44 h-5"></span>
                        <span class="text-transparent bg-gray-700 rounded block w-44 h-5"></span>
                        <span class="text-transparent bg-gray-700 rounded block w-44 h-5"></span>
                    </div>
                </div>
